...
ggplot(df_english_req_cont, aes(fill=`English Requirement`, y=Continent, x=perc, label = cnt)) +
...
ggplot(data_english_req_job, aes(fill=`English Requirement`, y=Job_Category, x=perc, label = cnt)) +
  geom_bar(stat="identity") +
  geom_text(size = 3, position = position_stack(vjust = 0.5)) +
